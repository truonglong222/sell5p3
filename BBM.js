...
async function main() {
  try {
    ...
    for (const coin of targetCoins) {
      ...
      // BƯỚC 4: Kiểm tra điều kiện Long / Short với diffbbm10 đã cập nhật
      const isLong = diffbbm10 > 0.5 && bbd1h > -2 && bbd1h < 0.5;
      const isShort = diffbbm10 < -0.5 && bbt1h > -0.5 && bbt1h < 2;
